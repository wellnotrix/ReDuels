package dev.veltrix.duels;

import com.google.common.collect.Lists;
import dev.veltrix.duels.command.commands.party.PartyCommand;
import dev.veltrix.duels.config.CommandsConfig;
import dev.veltrix.duels.core.kit.edit.KitEditListener;
import dev.veltrix.duels.core.kit.edit.KitEditManager;
import dev.veltrix.duels.listeners.*;
import dev.veltrix.duels.listeners.*;
...
import dev.veltrix.duels.api.Duels;
...
import dev.veltrix.duels.command.commands.SpectateCommand;
import dev.veltrix.duels.command.commands.KitCommand;
import dev.veltrix.duels.command.commands.duel.DuelCommand;
import dev.veltrix.duels.command.commands.duels.DuelsCommand;
import dev.veltrix.duels.command.commands.queue.QueueCommand;
import dev.veltrix.duels.config.Config;
import dev.veltrix.duels.config.Lang;
import dev.veltrix.duels.data.ItemData;
import dev.veltrix.duels.data.ItemData.ItemDataDeserializer;
import dev.veltrix.duels.data.UserManagerImpl;
import dev.veltrix.duels.core.DuelManager;
import dev.veltrix.duels.extension.ExtensionClassLoader;
import dev.veltrix.duels.extension.ExtensionManager;
...
import dev.veltrix.duels.util.logging.LogManager;

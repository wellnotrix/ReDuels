package dev.veltrix.duels.core.queue.sign;
...
import dev.veltrix.duels.api.event.queue.sign.QueueSignCreateEvent;
import dev.veltrix.duels.api.event.queue.sign.QueueSignRemoveEvent;
import dev.veltrix.duels.api.queue.sign.QueueSign;
import dev.veltrix.duels.api.queue.sign.QueueSignManager;
import dev.veltrix.duels.config.Lang;
import dev.veltrix.duels.data.QueueSignData;

package dev.veltrix.duels.gui.betting;

import dev.veltrix.duels.DuelsPlugin;
import dev.veltrix.duels.core.DuelManager;
import dev.veltrix.duels.gui.betting.buttons.CancelButton;
import dev.veltrix.duels.gui.betting.buttons.DetailsButton;
import dev.veltrix.duels.gui.betting.buttons.HeadButton;
import dev.veltrix.duels.gui.betting.buttons.StateButton;
...
import dev.veltrix.duels.util.gui.AbstractGui;
import dev.veltrix.duels.util.gui.Button;
import dev.veltrix.duels.util.gui.GuiListener;
import dev.veltrix.duels.util.inventory.InventoryBuilder;
import dev.veltrix.duels.util.inventory.InventoryUtil;
import dev.veltrix.duels.util.inventory.Slots;

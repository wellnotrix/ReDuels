package dev.veltrix.duels.util.inventory;
...
public final class ItemBuilder {
     ...
     */
    public ItemBuilder name(final String name, final Lang lang) {
     ...
     * Requires a Lang instance to check MiniMessage configuration.
     */
    public ItemBuilder lore(final List<String> lore, final Lang lang) {
     ...
     * Requires a Lang instance to check MiniMessage configuration.
     */
    public ItemBuilder lore(final Lang lang, final String... lore) {

package dev.veltrix.duels.util.gui;
...
import dev.veltrix.duels.util.compat.Skulls;
...
public class Button<P extends JavaPlugin> {
     ...
     */
    protected void setDisplayName(final String name, final Lang lang) {
     ...
     * Requires a Lang instance to check MiniMessage configuration.
     */
    protected void setLore(final Lang lang, final List<String> lore) {
        editMeta(meta -> {
     ...
     * Requires a Lang instance to check MiniMessage configuration.
     */
    protected void setLore(final Lang lang, final String... lore) {
